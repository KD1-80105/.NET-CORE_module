...
namespace FileIO
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /* string path = @"C:\Users\akhil\OneDrive\Desktop\Test\test.txt";
             FileStream fs = null;
            ...
            {
                case "a":
                    sWriter.WriteLine("<h1>Akhil Welcomes You</h1>");
                    break;

                case "b":
                    sWriter.WriteLine("<h2>Akhil Welcomes You</h2>");
                    break;

                case "c":
                    sWriter.WriteLine("<h3>Akhil Welcomes You</h3>");
                    break;

                case "d":
                    sWriter.WriteLine("<h4>Akhil Welcomes You</h4>");
                    break;
